...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    '/posts/Markdown-标题语法': RouteRecordInfo<'/posts/Markdown-标题语法', '/posts/Markdown-标题语法', Record<never, never>, Record<never, never>>,
    '/posts/Markdown-速览表': RouteRecordInfo<'/posts/Markdown-速览表', '/posts/Markdown-速览表', Record<never, never>, Record<never, never>>,
